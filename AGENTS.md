...
<!-- END:material-ui-9-rules -->

<!-- BEGIN:system-rules -->
# System Description
- Sistema para veterinário de campo 
- Nome do sistema é VetPlus
- Versão do sistema é 1.0.0
- Vamos ter uma interface de usuário simples e intuitiva
- Vamos ter uma interface de usuário em português
- Vamos ter uma tela de Clientes
- Vamos ter uma tela de Animais
- Vamos ter uma tela de Serviços
- Vamos ter uma tela de Atendimentos
