        ...
        <Box component="main">
          ...
          <Box component="section" sx={{ py: { xs: 10, md: 16 }, px: { xs: 2, md: 0 } }}>
            <Container maxWidth="md">
              <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)" }, gap: { xs: 4, md: 8 }, alignItems: "center" }}>
                {/* PLANO FREE */}
                <Card elevation={0} sx={{ backgroundColor: COLORS.white, borderRadius: "24px", border: `1px solid ${COLORS.border}`, height: "100%", display: "flex", flexDirection: "column" }}>
                  <CardContent sx={{ p: { xs: 4, md: 5 }, flex: 1, display: "flex", flexDirection: "column" }}>
                    <Box sx={{ mb: 4 }}>
                      <Typography component="h2" variant="h5" sx={{ fontWeight: 700, color: COLORS.textMain, mb: 1 }}>
                        Free (30 Dias)
                      </Typography>
                      <Typography sx={{ color: COLORS.textLight, fontSize: "0.95rem" }}>Para testar a plataforma na prática</Typography>
                    </Box>
                    <Box sx={{ mb: 4 }}>
                      <Typography component="span" variant="h3" sx={{ fontWeight: 700, color: COLORS.textMain }}>
                        R$ 0
                      </Typography>
                    </Box>
                    ...
                    <Link href="/app/authentication/create" style={{ textDecoration: "none" }}>
                      <Button
                        ...
                        sx={{
                          ...
                          fontWeight: 600,
                          textTransform: "none",
                          "&:hover": { backgroundColor: "rgba(197, 155, 118, 0.1)", borderColor: COLORS.accentHover },
                        }}
                      >
                        Começar Grátis
                      </Button>
                ...
                <Card elevation={24} sx={{ backgroundColor: COLORS.dark, borderRadius: "24px", height: "105%", display: "flex", flexDirection: "column", position: "relative", transform: { md: "scale(1.05)" }, zIndex: 2 }}>
                  <CardContent sx={{ p: { xs: 4, md: 5 }, flex: 1, display: "flex", flexDirection: "column" }}>
                    <Box sx={{ mb: 4 }}>
                      <Typography component="h2" variant="h5" sx={{ fontWeight: 700, color: COLORS.white, mb: 1 }}>
                        Pro
                      </Typography>
                      <Typography sx={{ color: "rgba(255,255,255,0.7)", fontSize: "0.95rem" }}>Ideal para profissionais autônomos</Typography>
                    </Box>
                    <Box sx={{ mb: 4, display: "flex", alignItems: "flex-end", gap: 1 }}>
                      <Typography component="span" variant="h3" sx={{ fontWeight: 700, color: COLORS.white }}>
                        R$ 79,90
                      </Typography>
                      <Typography component="span" sx={{ color: "rgba(255,255,255,0.5)", mb: 1 }}>
                        /mês
                      </Typography>
                    </Box>
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2, flex: 1, mb: 4 }}>
                      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <FiCheckCircle color={COLORS.accent} size={20} />
                        <Typography sx={{ color: COLORS.white, fontWeight: 500 }}>Full Clientes</Typography>
                      </Box>
                      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <FiCheckCircle color={COLORS.accent} size={20} />
                        <Typography sx={{ color: COLORS.white, fontWeight: 500 }}>Full Animais</Typography>
                      </Box>
                      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <FiCheckCircle color={COLORS.accent} size={20} />
                        <Typography sx={{ color: COLORS.white, fontWeight: 500 }}>Agenda</Typography>
                      </Box>
                    ...
                    <Link href="/app/authentication/create" style={{ textDecoration: "none" }}>
                      <Button
                        fullWidth
                        variant="contained"
                        sx={{ backgroundColor: COLORS.accent, color: COLORS.white, borderRadius: "12px", py: 1.5, fontWeight: 600, textTransform: "none", "&:hover": { backgroundColor: COLORS.accentHover } }}
                      >
                        Assinar Pro
                      </Button>
                    </Link>
