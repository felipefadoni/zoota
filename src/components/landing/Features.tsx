      ...
      <Box component="section" sx={{ backgroundColor: COLORS.white, py: 6, borderBottom: `1px solid ${COLORS.border}` }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: { xs: 4, md: 8 }, opacity: 0.5, filter: "grayscale(100%)" }}>
            <Typography variant="h5" sx={{ fontWeight: "bold", fontFamily: "'Playfair Display', serif" }}>Haras Vitória</Typography>
            <Typography variant="h5" sx={{ fontWeight: "bold", fontFamily: "'Playfair Display', serif" }}>Estância Luz</Typography>
            <Typography variant="h5" sx={{ fontWeight: "bold", fontFamily: "'Playfair Display', serif" }}>VetRural</Typography>
            <Typography variant="h5" sx={{ fontWeight: "bold", fontFamily: "'Playfair Display', serif" }}>AgroPlus</Typography>
          </Box>
        </Container>
      </Box>
      ...
      <Box component="section" id="recursos" sx={{ py: { xs: 10, md: 16 } }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3, 1fr)" }, gap: 4 }}>
            <Card elevation={0} sx={{ backgroundColor: COLORS.white, borderRadius: "20px", border: `1px solid ${COLORS.border}`, transition: "transform 0.3s, box-shadow 0.3s", "&:hover": { transform: "translateY(-5px)", boxShadow: "0 20px 40px rgba(0,0,0,0.05)" } }}>
              <CardContent sx={{ p: 5 }}>
                ...
                <Typography component="h3" variant="h5" sx={{ fontWeight: 700, mb: 2, color: COLORS.textMain }}>Prontuário Eletrônico</Typography>
                <Typography sx={{ color: COLORS.textLight, lineHeight: 1.6 }}>
                  Acompanhe o histórico clínico, exames, vacinas e pesagem de equinos e bovinos de forma individual e detalhada.
                </Typography>
              </CardContent>
            </Card>
            ...
            <Card elevation={0} sx={{ backgroundColor: COLORS.white, borderRadius: "20px", border: `1px solid ${COLORS.border}`, transition: "transform 0.3s, box-shadow 0.3s", "&:hover": { transform: "translateY(-5px)", boxShadow: "0 20px 40px rgba(0,0,0,0.05)" } }}>
              <CardContent sx={{ p: 5 }}>
                ...
                <Typography component="h3" variant="h5" sx={{ fontWeight: 700, mb: 2, color: COLORS.textMain }}>Controle Financeiro</Typography>
                <Typography sx={{ color: COLORS.textLight, lineHeight: 1.6 }}>
                  Gere faturas veterinárias, compartilhe cobranças via WhatsApp e gerencie pagamentos da sua clínica rural.
                </Typography>
              </CardContent>
            </Card>
            ...
            <Card elevation={0} sx={{ backgroundColor: COLORS.white, borderRadius: "20px", border: `1px solid ${COLORS.border}`, transition: "transform 0.3s, box-shadow 0.3s", "&:hover": { transform: "translateY(-5px)", boxShadow: "0 20px 40px rgba(0,0,0,0.05)" } }}>
              <CardContent sx={{ p: 5 }}>
                ...
                <Typography component="h3" variant="h5" sx={{ fontWeight: 700, mb: 2, color: COLORS.textMain }}>Gestão de Fazendas</Typography>
                <Typography sx={{ color: COLORS.textLight, lineHeight: 1.6 }}>
                  Organize clientes, proprietários de haras e fazendas em uma base de dados inteligente.
                </Typography>
              </CardContent>
            </Card>
          </Box>
          ...
          <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: "center", gap: { xs: 8, md: 12 } }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                {[
                  "Histórico reprodutivo e exames laboratoriais na palma da mão.",
                  "Notificações automáticas para reforço de vacinas.",
                  "Emissão e envio de relatórios e receitas pelo WhatsApp.",
                ].map((item, index) => (
                  <Box key={index} sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                    <Box sx={{ mt: 0.5, color: COLORS.accent }}>
                      <FiCheckCircle size={20} />
                    </Box>
                    <Typography sx={{ color: COLORS.textMain, fontWeight: 500, fontSize: "1.05rem" }}>
                      {item}
                    </Typography>
                  </Box>
                ))}
