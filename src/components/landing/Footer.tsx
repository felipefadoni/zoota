    ...
    <Box component="footer" id="contato" sx={{ backgroundColor: "#151211", pt: 10, pb: 4 }}>
      <Container maxWidth="lg">
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr", md: "2fr 1fr 1fr 1.5fr" }, gap: 8, mb: 8 }}>
          ...
          <Box>
            <Typography component="h3" sx={{ color: COLORS.white, fontWeight: 600, mb: 3 }}>
              Plataforma
            </Typography>
            <Box component="nav" sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Link href="/recursos" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Recursos do Sistema
              </Link>
              <Link href="/beneficios" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Benefícios
              </Link>
              <Link href="/planos" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Planos e Preços
              </Link>
              <Link href="/contato" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Contato
              </Link>
              <Link href="/app/authentication/login" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Acesso ao Sistema
              </Link>
            </Box>
          </Box>
          ...
          <Box>
            ...
            <Box component="nav" sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <Link href="#" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Sobre nós
              </Link>
              <Link href="#" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.95rem" }}>
                Blog Veterinário
        ...
        <Box sx={{ borderTop: "1px solid rgba(255,255,255,0.1)", pt: 4, display: "flex", flexDirection: { xs: "column", md: "row" }, justifyContent: "space-between", alignItems: "center", gap: 2 }}>
          <Typography sx={{ color: "rgba(255,255,255,0.4)", fontSize: "0.85rem" }}>&copy; {new Date().getFullYear()} ZooTa. Todos os direitos reservados.</Typography>
          <Typography sx={{ color: "rgba(255,255,255,0.4)", fontSize: "0.85rem" }}>Feito com excelência para o médico veterinário rural.</Typography>
        </Box>
      </Container>
    </Box>
  );
